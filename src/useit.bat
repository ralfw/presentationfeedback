...
coapp.console.exe upload -id:conf1 -title:"conference #2" -timezone:"FLE Standard Time" -filename:"conf2.txt"
...
REM coapp.console.exe feedback -id:conf1
 
REM afapp.console.exe conferences